...
public:
    ...
    void CopyRange(It range_begin, It range_end) {
        ...
        tmp.size_ = std::distance(range_begin, range_end);
        swap(tmp);
    }
    ...
    */
    ...
    void PopFront() noexcept {
        ...
        Node* front_elem = head_.next_node;
        head_.next_node = front_elem->next_node;
        delete front_elem;
        --size_;
    }
